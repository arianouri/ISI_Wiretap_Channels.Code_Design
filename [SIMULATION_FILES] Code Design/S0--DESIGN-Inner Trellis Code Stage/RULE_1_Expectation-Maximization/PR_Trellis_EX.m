function [ Trans_Minimal , Trans_Extended , Trellis_Minimal , Trellis_Extended , Trellis_Extended_io , branchIndex_Vec, Ch_Inp ] = PR_Trellis_EX( FrequencyResponse , Number_of_inputs , State_Cardinality )
...
Ch_Inp = zeros(size(Trans_Extended));
for mnrIndex=1:size(Trellis_Extended,1)
    for mncIndex=1:Number_of_inputs
       ...
       Ch_Inp(Trellis_Extended(mnrIndex,1),...
              Trellis_Extended(mnrIndex,end),...
              branchIndex_Vec(mnrIndex),...
              mncIndex) ...
                      = tblInput(( Trellis_Extended(mnrIndex,mncIndex)   == Trellis_Minimal(:,1) &...
                                   Trellis_Extended(mnrIndex,mncIndex+1) == Trellis_Minimal(:,2) ),...
                                   end);
    end
end