...
% R_in = 1/4;
% auxRs = 0.055;
% p_rl   =auxRs/(R_in+auxRs);
% MAIN = updateSNR(MAIN,-5);

% function [Lambda] = LDPC_opt_ready(Objective,Inequality,Equality,...
%                                   tol,tol_feas,...
...
% Eps = 2e-2; % this parameter is used in the line search.
